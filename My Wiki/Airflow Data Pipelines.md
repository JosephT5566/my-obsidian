...
type: concept
status: growing
topics: [airflow, data-pipeline, dag]
created: "2026-07-14"
---
...
Apache Airflow 用 Directed Acyclic Graph（DAG）描述有依賴關係的資料工作，提供 scheduling、retry、觀測與流程視覺化。Houzz 的方向是把長期偏離 upstream 的 Luigi workflows 遷移到仍活躍維護的 Airflow。
