...
type: concept
status: growing
topics: [rpc, thrift, service-architecture]
created: "2026-07-14"
---
...
在 Houzz 架構中，GraphQL 是前端使用的 query layer，Thrift 則是 service-to-service layer：React → GraphQL resolver → Thrift client → C2 PHP 或其他 Thrift service → database。
